...
terminal-log [Flet](https://flet.dev) extension.
...
Add `flet-terminal-log` dependency to the `pyproject.toml` of your Flet project:

* **From Git**

```toml
dependencies = [
  "flet-terminal-log @ git+https://github.com/MY_GITHUB_ACCOUNT/terminal-log",
  "flet>=0.86.5",
]
```
...
Detailed documentation for this package can be found [here](https://MY_GITHUB_ACCOUNT.github.io/terminal-log/).
